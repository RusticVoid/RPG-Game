...
function love.load()
	...
	EditWorld = editWorld.new({width = 30, height = 30, exitInfo = {location = currentLocation, x = Player.x, y = Player.Y}})
...
function love.mousepressed(x, y, button)
	EditMode:mousepressed(x, y, button)
end
